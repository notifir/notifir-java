...
public class Matchers extends TypeSafeDiagnosingMatcher<RecordedRequest> {
  ...
  private Matchers(String first, String second, int checkingOption) {
  ...
  public static Matchers hasMethodAndPath(String method, String path) {
    return new Matchers(method, path, METHOD_PATH);
  }

  public static Matchers hasHeader(String name, String value) {
    return new Matchers(name, value, HEADER);
  }

  public static Matchers hasQueryParameter(String name, String value) {
    return new Matchers(name, value, QUERY_PARAMETER);
  }

  public static Matchers hasQueryParameter(String name) {
    return new Matchers(name, null, QUERY_PARAMETER_PRESENCE);
  }
}
